...
static const range_mapping frequency_ranges[FREQUENCY_RANGE_COUNT] = {
...
static const range_mapping voltage_ranges[VOLTAGE_RANGE_COUNT] = {
	{24000000, 2}, {48000000, 2 - BOOSTEN}, {96000000, 1 - BOOSTEN},
};
...
static void _stm32_acquireHsi(clock_owner owner)
{
...
static void _stm32_releaseHsi(clock_owner owner)
{
	if (stm32_common.hsiRefs == 0) {
		return;
	}
...
int _stm32_rccSetCPUClock(u32 hz)
{
	...
	const range_mapping *frequency_range, *voltage_range;
